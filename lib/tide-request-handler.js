...
export default class TideRequestHandler {
    ...
    static handleSingleRequest(request) {
        ...
        if(action == 'run_config_command') {
          ...
          if (!AtomRequest.hasSentBufferRunStartup) {
            //AtomRequest.runAfterCommandConfigEvents();
          }
          if (AtomRequest.hasSentRunStartup && AtomRequest.hasSentBufferRunStartup) {
              // TODO: user/editor initiated request
          }
        }
