...
export default class Dictionary {
    ...
    static getCommands() {
      return Dictionary.dictionary["commands"];
    }

    static getBuffers() {
      return Dictionary.dictionary["buffers"];
    }

    static getBuffer(buffer_name) {
      return Dictionary.getBuffers()[buffer_name]||{}
    }

    static getCommandsArray() {
      return Array.from(Object.keys(this.getCommands()));
    }
}
