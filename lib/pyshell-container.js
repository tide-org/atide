...
export default class PyshellContainer {
    ...
    static spawnTide() {
      ...
      Log.toCon(Config.displayStartupMessages, "  Proc name:   " + Config.pythonProcessName);
      Log.toCon(Config.displayStartupMessages, "  Script path: " + PyshellContainer.scriptPath);
