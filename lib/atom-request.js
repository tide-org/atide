...
export default class AtomRequest {
    ...
    static requestObject = {
              "command": {"action": null, "value": null},
              "sender": "editor", "receiver": "tide", "has_callback" : true, "event_id": null
            };
    ...
    static sendRunConfigCommand(command, buffer_name='', event_input_args={}) {
      ...
      request.command.value = {'command': command, 'buffer_name': buffer_name, 'event_input_args': event_input_args};
